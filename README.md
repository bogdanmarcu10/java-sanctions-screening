...
* **OOP (Programare Orientată pe Obiect):** Utilizare extensivă a interfețelor și claselor abstracte pentru a asigura un cod decuplat, modular și ușor de extins.
* **Fiabilitate:** 
  * Implementare de *custom exception handling* pentru a gestiona corect scenariile de neconformitate (ex: identificarea unui client aflat pe liste de sancțiuni).
  * Validarea logicii de business prin redactarea și rularea de teste automate.
